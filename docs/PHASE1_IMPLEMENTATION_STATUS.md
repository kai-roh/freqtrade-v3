...
| Phase 2 | 2026-09-16 사전등록 완료([문서](PHASE2_PREREGISTRATION.md), Decision 0008) | 데이터 확장·`v3/phase2/` 구현·walk-forward 실행; Phase 1 관측과 병행 |
...
1. ~~의도적 재시작 2회 추가~~ 완료: 14:31 UTC와 16:36 UTC에 보유 중 강제 종료·재개
   성공(총 3회, 재헤지·중복 진입 0). 남은 것은 에피소드 50회 이상 집계와 정지 이벤트
   (`telegram_pause`, 오류) 발생 시 원인 확인 후 재시작.
